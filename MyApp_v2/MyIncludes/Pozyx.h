...
*/
     ...
     int _sw_version;         // Pozyx software (firmware) version. (By updating the firmware on the Pozyx device, this value can change)
    ...
    */
     int begin(BOOL print_result, int mode/* = MODE_INTERRUPT*/,  int interrupts/* = POZYX_INT_MASK_ALL*/, int interrupt_pin/* = POZYX_INT_PIN0*/);
 ...
 */
    ...
    *
    */
     char* getSystemError(uint16_t remote_id /*= NULL*/);
 ...
 */
    ...
    */
     int doRemoteRanging(uint16_t device_from, uint16_t device_to, device_range_t *device_range);
 ...
 */    
    ...
    * @retval #POZYX_FAIL function failed.
    */
     int getDeviceIds(uint16_t devices[], int size/* = MAX_ANCHORS_IN_LIST*/, uint16_t remote_id/* = NULL*/);
    ...
    * @retval #POZYX_FAIL function failed.
    */
     int getAnchorIds(uint16_t anchors[], int size/* = MAX_ANCHORS_IN_LIST*/, uint16_t remote_id/* = NULL*/);
    ...
    * @retval #POZYX_FAIL function failed.
    */
     int getTagIds(uint16_t tags[], int size/* = MAX_ANCHORS_IN_LIST*/, uint16_t remote_id/* = NULL*/);
