...
#include "SystemProfile.h"
    ...
    #elif defined(__PIC32MX__)
            //JDL void __ISR(_EXTERNAL_1_VECTOR, ipl4) _INT1Interrupt(void)
            void __ISR(_EXTERNAL_3_VECTOR, ipl4) _INT3Interrupt(void)       //JDL
    #else
