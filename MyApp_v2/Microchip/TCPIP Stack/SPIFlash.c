...
#define  SPIFLASH_DISABLE_INT   int MySPIFLASH_intStatus; \
                                MySPIFLASH_intStatus = INTDisableInterrupts()   //JDL
#define  SPIFLASH_ENABLE_INT    INTRestoreInterrupts(MySPIFLASH_intStatus)      //JDL
...
//JDL        SPIFLASH_SPIBRG = (GetPeripheralClock()-1ul)/2ul/SPIFLASH_MAX_SPI_FREQ;
