...
typedef enum {CALIBRATE, WAIT_FOR_START1, CABINS, BLOCKS_FRONT, BLOCKS_DUNE_1, BLOCKS_DUNE_2, BLOCKS_CABINS, FISH, PARASOL, STOP} robinsun_competition;
