...
typedef enum {GOTO_FC, WAIT_FOR_POSITION_FC, POSITION_FC, GO_CATCH_FC, PARK_FC, BRING_OUT_FC, LOWER_FC, SWEEP_FC, BACKWARDS_FC, GO_UP_FC, SOMEWHAT_IN_FC, LEAVE_SWEEP_FC, GO_NET_FC, BRING_IN_FC, LEAVE_FISH_FC
} fish_catch_t;
