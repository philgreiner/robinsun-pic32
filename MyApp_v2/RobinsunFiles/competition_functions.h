...
typedef enum {GOTO_BC, WAIT_FOR_POSITION_BC, CALIBRATE_BC, POSITION_BC, CALIBRATE_X_BC, FORWARD_BC, CLAMP_BC, BACKWARDS_W1_BC, BACKWARDS_W2_BC, BRING_BC, UNCLAMP_BC, MOVE_BACK_BC
} blocks_cabins_t;
