...
typedef enum {GOTO_BD1, WAIT_FOR_POSITION_BD1, TURN_BD1, FORWARD_BD1, CLAMP_BD1, MOVE_BACK_BD1, POS_BD1, BRING_BD1, UNCLAMP_BD1, MOVE_BACK_BD1_END
} blocks_dune_1_t;
void blocks_dune_1(CtrlStruct *cvs);
void blocks_dune_2(CtrlStruct *cvs);

typedef enum {GOTO_FC, WAIT_FOR_POSITION_FC, POSITION_FC, GO_CATCH_FC, PARK_FC, BRING_OUT_FC, LOWER_FC, SWEEP_FC, GO_UP_FC, LEAVE_SWEEP_FC, GO_NET_FC, BRING_IN_FC
} fish_catch_t;
